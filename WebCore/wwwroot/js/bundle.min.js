                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-primary confirm">${i}</button>
                                    <button type="button" class="btn btn-secondary cancel" data-dismiss="modal">${r}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    `;e.html(s);u&&e.find(">.modal .confirm").click(function(n){u(n)});f&&e.find(">.modal .cancel").click(function(n){f(n)});e.find(">.modal").modal()};resetSelect2($("body"));