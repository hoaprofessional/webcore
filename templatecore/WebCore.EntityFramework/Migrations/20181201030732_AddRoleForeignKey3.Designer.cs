...
namespace WebCore.EntityFramework.Migrations
{
    ...
    [Migration("20181201030732_AddRoleForeignKey3")]
    partial class AddRoleForeignKey3
    {
            ...
            modelBuilder.Entity("WebCore.Entities.WebCoreRoleClaim", b =>
                {
                    ...
                    b.Property<string>("WebCoreRoleId");

                    b.HasKey("Id");

                    b.HasIndex("RoleId");

                    b.HasIndex("WebCoreRoleId");
